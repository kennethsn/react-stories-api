...
import IdBadgesMoment from './IdBadgesMoment';
...
const momentData = {
  ...
  data: {
    id_badges: [
      {
        background_image: { url: 'https://upload.wikimedia.org/wikipedia/commons/5/56/Aerial_view_of_Apple_Park_dllu.jpg', alt: 'Apple HQ' },
        caption: {
          blocks: [
      ...
      {
        background_image: { url: 'https://upload.wikimedia.org/wikipedia/commons/5/5f/Aerial_Microsoft_West_Campus_August_2009.jpg', alt: 'Microsoft HQ' },
        caption: {
          blocks: [
...
export const DefaultIdBadgesMoment = {
  name: 'Default ID Badges',
  args: {
    moment: momentData,
  },
};
